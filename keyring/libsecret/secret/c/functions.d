...
__gshared extern(C)
{
	...
	SecretBackend* function(GAsyncResult* result, GError** err) c_secret_backend_get_finish;
	...
	SecretValue* function(SecretRetrievable* self, GAsyncResult* result, GError** err) c_secret_retrievable_retrieve_secret_finish;
	SecretValue* function(SecretRetrievable* self, GCancellable* cancellable, GError** err) c_secret_retrievable_retrieve_secret_sync;
...
alias c_secret_backend_get_type secret_backend_get_type;
alias c_secret_backend_get secret_backend_get;
alias c_secret_backend_get_finish secret_backend_get_finish;
...
alias c_secret_retrievable_get_type secret_retrievable_get_type;
alias c_secret_retrievable_get_attributes secret_retrievable_get_attributes;
alias c_secret_retrievable_get_created secret_retrievable_get_created;
alias c_secret_retrievable_get_label secret_retrievable_get_label;
alias c_secret_retrievable_get_modified secret_retrievable_get_modified;
alias c_secret_retrievable_retrieve_secret secret_retrievable_retrieve_secret;
alias c_secret_retrievable_retrieve_secret_finish secret_retrievable_retrieve_secret_finish;
alias c_secret_retrievable_retrieve_secret_sync secret_retrievable_retrieve_secret_sync;
