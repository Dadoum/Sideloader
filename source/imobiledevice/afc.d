...
struct afc_client_private; /**< \private */
alias afc_client_t = afc_client_private*; /**< The client handle. */
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_file_open (afc_client_t client, const(char)* filename, afc_file_mode_t file_mode, ulong* handle);
 ...
 */
afc_error_t afc_file_close (afc_client_t client, ulong handle);
 ...
 *        AFC_LOCK_UN (unlock).
 */
afc_error_t afc_file_lock (afc_client_t client, ulong handle, afc_lock_op_t operation);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_file_read (afc_client_t client, ulong handle, char* data, uint length, uint* bytes_read);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_file_write (afc_client_t client, ulong handle, const(char)* data, uint length, uint* bytes_written);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_file_seek (afc_client_t client, ulong handle, long offset, int whence);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_file_tell (afc_client_t client, ulong handle, ulong* position);
 ...
 */
afc_error_t afc_file_truncate (afc_client_t client, ulong handle, ulong newsize);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_truncate (afc_client_t client, const(char)* path, ulong newsize);
 ...
 * @return AFC_E_SUCCESS on success or an AFC_E_* error value.
 */
afc_error_t afc_set_file_time (afc_client_t client, const(char)* path, ulong mtime);
