...
module imobiledevice.installation_proxy;
...
struct instproxy_client_private; /**< \private */
alias instproxy_client_t = instproxy_client_private*; /**< The client handle. */

/** Reports the status response of the given command */
alias instproxy_status_cb_t = void function (plist_t command, plist_t status, void* user_data);
 ...
 */
instproxy_error_t instproxy_status_get_error (plist_t status, char** name, char** description, ulong* code);
 ...
 */
void instproxy_status_get_current_list (plist_t status, ulong* total, ulong* current_index, ulong* current_amount, plist_t* list);
